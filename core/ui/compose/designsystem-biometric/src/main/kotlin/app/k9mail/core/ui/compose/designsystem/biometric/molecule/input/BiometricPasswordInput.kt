package app.k9mail.core.ui.compose.designsystem.biometric.molecule.input
...
import app.k9mail.core.ui.compose.designsystem.biometric.R
import app.k9mail.core.ui.compose.designsystem.biometric.atom.textfield.TextFieldOutlinedPasswordBiometric
...
fun BiometricPasswordInput(
    ...
    InputLayout(
        ...
        val title = stringResource(R.string.designsystem_biometric_molecule_password_authentication_title)
        val subtitle = stringResource(R.string.designsystem_biometric_molecule_password_authentication_subtitle)
        val needScreenLockMessage =
            stringResource(R.string.designsystem_biometric_molecule_password_authentication_screen_lock_required)
